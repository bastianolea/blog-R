...
date: '2025-07-17'
weight: 25
featured_image: ‘/blog/web_scraping/featured.png’
tags:
  - web scraping
links:
  - icon: link
...
[**Tutorial de {rvest}**](/blog/webscraping_rvest/)
...
## [{RSelenium}](/blog/webscraping_selenium/)
...
[**Tutorial de {RSelenium}**](/blog/webscraping_selenium/)
...
## [{chromote}](/blog/webscraping_chromote/)
...
[**Tutorial de {chromote}**](/blog/webscraping_chromote/)
...
- [Ejemplo de web scraping de un sitio web de Transparencia Activa (Chile) con `{RSelenium}`](blog/webscraping_selenium/#navegar-a-un-sitio-web)
...
- [Extracción de una tabla de Wikipedia con `{rvest}`](blog/webscraping_rvest/#extraer-tablas-desde-un-sitio-web)
