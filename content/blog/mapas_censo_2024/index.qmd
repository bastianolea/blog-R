...
Para visualizar **mapas interactivos** en R existen varias opciones, como [el paquete `{leaflet}`](https://rstudio.github.io/leaflet/), pero yo quería usar [el paquete `{mapgl}`](https://walker-data.com/mapgl/), desarrollado por [Kyle Walker](https://walker-data.com) que permite crear mapas interactivos usando [MapLibre](https://maplibre.org), una biblioteca de código abierto para mapas web.
