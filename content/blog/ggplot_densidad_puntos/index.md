...
tags:
  ...
  - estadísticas
excerpt: >-
  En este tutorial vamos a crear una visualización que representa la densidad
  poblacional de distintas ciudades usando círculos y puntos: cada círculo
  representa 1 km² de superficie, y cada punto dentro del círculo representa un
  número de habitantes. El resultado permite comparar de forma visual e
  intuitiva cuán densa es la población de distintos lugares.
---
...
<img src="index.markdown_strict_files/figure-markdown_strict/unnamed-chunk-14-1.png" width="864" />
