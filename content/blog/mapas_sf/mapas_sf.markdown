...
También podemos ampliar el recorte que hacemos del mapa de fondo **ampliando** la caja al [aplicarle un _buffer_](/blog/mapas_sf/#calcular-buffer) a la región con `st_buffer()`:
