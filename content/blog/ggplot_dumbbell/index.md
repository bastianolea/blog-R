...
tags:
  ...
  - gráficos
excerpt: >-
  En este tutorial aprenderemos a crear gráficos de puntos comparativos o
  _dumbbell_ `{ggplot2}`, que permiten comparar un valor en dos momentos en el
  tiempo, usando datos reales de delincuencia en Chile para comparar tasas de
  delitos entre 2018 y 2024.
format:
  hugo-md:
    output-file: index
    output-ext: md
