...
tags:
  ...
  - gráficos
excerpt: >-
  Los gráficos de puntos comparativos o _dumbbell_ `{ggplot2}` permiten comparar
  un valor en dos momentos en el tiempo de forma clara y llamativa. En este
  tutorial usaremos datos reales de delincuencia en Chile para comparar tasas de
  delitos entre 2018 y 2024 mediante este tipo de gráficos.
format:
  hugo-md:
    output-file: index
    output-ext: md
