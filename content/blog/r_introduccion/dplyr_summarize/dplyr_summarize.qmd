...
tags:
  - dplyr
  - básico
excerpt: "En este tutorial veremos cómo calcular resúmenes de datos con la función `summarize()`, que nos permite tomar las filas de una tabla de datos, y aplicarles algún cálculo para reducir todas las filas a un solo dato; por ejemplo, para calcular la suma o el promedio de una columna."
execute: 
  error: true
  eval: true
links:
