...
excerpt: >-
  Los datos pueden existir en distintos formatos o estructuras, y el poder
  transformar los datos entre distintas estructuras es una habilidad clave. En
  este tutorial aprenderemos a usar las funciones `pivot_longer()` y
  `pivot_wider()` del paquete `{tidyr}` para cambiar entre formatos de datos
  _ancho_ (_wide_) y _largo_ (_long_).
---
...
<img src="tidyr_pivotar.markdown_strict_files/figure-markdown_strict/unnamed-chunk-12-1.png" width="768" />
...
<img src="tidyr_pivotar.markdown_strict_files/figure-markdown_strict/unnamed-chunk-18-1.png" width="768" />
