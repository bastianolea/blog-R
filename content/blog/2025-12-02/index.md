...
### Mejoras al buscador
También mejoré el [buscador de mi blog](/buscar/), que es [una aplicación Shiny](https://bastianolea.rbind.io/blog/buscador/), para que sea un poquito más rápido, pero principalmente para que los resultados de búsqueda contengan un **resumen de cada publicación**. Más información sobre el buscador [en este post](https://bastianolea.rbind.io/blog/buscador/).
...
{{< boton "Buscador" "/buscar/" "fas fa-search" >}}
