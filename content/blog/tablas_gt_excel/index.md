...
execute:
  ...
  warning: false
excerpt: >-
  Con `{gtxlsx}` puedes exportar tus tablas `{gt}` fácilmente en archivos de
  Excel editables, manteniendo todas sus características visuales. Esto facilita
  muchísimo la exportación de datos desde R, ya sea para su procesamiento, para
  consulta o para presentación de resultados, manteniendo un estándar visual
  mucho más elevado.
links:
  - icon: registered
    icon_pack: fas
