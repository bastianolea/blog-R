...
excerpt: >-
  Este paquete entrega herramientas básicas para limpiar, validar y verificar el
  número de cédula de identidad Chilena en R. Es mi primer paquete de R y lo
  hice para aprender!
---
...
{{< paquete "Paquete `{rutera}`"   "https://bastianolea.github.io/rutera/"   "hex-featured.png"   "Herramientas para limpiar, validar y verificar el número de cédula de identidad Chilena en R. Estas funciones ayudan a realizar operaciones frecuentes para datos de ciudadanos chilenos que incluyen el RUT como identificador único." >}}
