...
Si te fijas, al primer elemento le dimos un `id` para poder hacerlo aprecer, mientras que el segundo tiene como identificador el valor de _input_, que es `region`.
