...
execute:
  message: false
  warning: false
excerpt: Cuando trabajamos con fechas, a veces necesitamos formatear o redactar las fechas en español, para pasar de números a un texto que redacte la fecha. Para eso tenemos en R la función `format()`, de manera que el mes `03` pasa a ser _marzo_.
links:
  - icon: registered
    icon_pack: fas
    name: Lubridate
