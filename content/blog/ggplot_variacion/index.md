...
delitos_tasa_5 |> 
  ...
  ggplot() +
  aes(x = delito, #reordenar_ranking(variable),
      y = tasa, 
      color = año) +
  # # fondos
  # geom_rect(
  ...
  #   inherit.aes = F,
  #   alpha = c(0.28, 0.15, 0.04)
  # ) +
  # flechas
  geom_path(aes(group = delito, y = pos),
  ...
  geom_text(
    ...
    aes(label = dif,
        y = if_else(tipo == "sube", tasa + 1.4, tasa - 0.4)),
    size = 3, nudge_y = 0.5, show.legend = F) + 
  geom_text(
    aes(label = tasa),
