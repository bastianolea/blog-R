---
title: "Medir el ancho de una aplicación Shiny como una variable reactiva y usarla para adaptar sus contenidos"
...
{{< info "Tengo un [tutorial](/blog/shiny_ocultar/) más completo sobre mostrar y ocultar elementos en Shiny usando `{shinyjs}`! [Revisa este post](/blog/shiny_ocultar/) para aprender a usar `show()` y `hide()` para controlar la visibilidad de los elementos de tu app." >}}
