...
#| eval: false
#| echo: false
readr::write_rds(calles_grandes, "calles_grandes.rds", compress = "gz")
readr::write_rds(calles_medianas, "calles_medianas.rds", compress = "gz")
readr::write_rds(calles_chicas, "calles_chicas.rds", compress = "gz")
```

```{r}
#| eval: true
#| echo: false
calles_grandes <- readr::read_rds("calles_grandes.rds")
calles_medianas <- readr::read_rds("calles_medianas.rds")
calles_chicas <- readr::read_rds("calles_chicas.rds")
```
